...
public class PtoAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        editButton.setOnClickListener(v -> {
            Intent iLaunchEditPtoRequest = new Intent(context, com.example.employeeapp.EditPtoRequest.class);
    ...
    private void updateRequestStatus(PtoRequest ptoRequest, String updatedStatus) {
        ...
        com.example.employeeapp.NotificationHelper.showNotification(context, "PTO Status Change", "The status of your PTO Request has changed.");
